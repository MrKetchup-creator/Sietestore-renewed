...
## 👥 Equipo de Desarrollo (DOP Group)
*   **Jeison Clavijo:** Project Manager / Database Administrator (Gestor de Proyecto).
*   **Sebastián:** Lead Backend Developer (Spring Boot Expert).
*   **Johan:** Lead Frontend Developer (React Architect).
*   **Alexander / Deinnys:** Stakeholders & QA (Validación de Requisitos).

---

## 🏗️ Estructura del Proyecto
Para garantizar la escalabilidad y el orden académico, el repositorio se organiza de la siguiente manera:

*   **`/backend`**: API Rest construida con Java y Spring Boot (En desarrollo).
*   **`/frontend`**: Interfaz de usuario SPA construida con React, Vite y Tailwind CSS (En desarrollo).
*   **`/docs`**: Toda la documentación técnica y evidencias académicas entregadas en clase.
    *   `docs/entregas-academia/`: Carpeta con los archivos específicos del Corte 1 y Corte 2[cite: 5].
    *   `docs/diseño/`: Mockups de alta fidelidad y diagramas de arquitectura.
